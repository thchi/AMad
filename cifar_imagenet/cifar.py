...
parser.add_argument('--test-batch', default=100, type=int, metavar='N',
                    help='test batchsize')
parser.add_argument('--optimizer', default='sgd', type=str, choices=['amadam', 'sgd','adam', 'adagrad','adamw', 'adamax','radam'])
...
def main():
    ...
    elif args.optimizer.lower() == 'amadam':
        optimizer = AMadam(model.parameters(), lr=args.lr, betas=(args.beta1, args.beta1), weight_decay=args.weight_decay, warmup=args.warmup)
    elif args.optimizer.lower() == 'adamax':
         optimizer = optim.Adamax(model.parameters(), lr=args.lr, betas=(args.beta1, args.beta2), weight_decay=args.weight_decay)
    elif args.optimizer.lower() == 'radam':
        optimizer = RAdam(model.parameters(), lr=args.lr, betas=(args.beta1, args.beta2), weight_decay=args.weight_decay, warmup=args.warmup)
    elif args.optimizer.lower() == 'adadelta':
         optimizer = optim.Adadelta(model.parameters(), lr=args.lr,  rho=args.rho, weight_decay=args.weight_decay)
    elif args.optimizer.lower() == 'adagrad':
        optimizer = Adagrad(model.parameters(), lr=args.lr, weight_decay=args.weight_decay, warmup=args.warmup)
